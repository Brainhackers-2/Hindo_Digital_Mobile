...
/**
 * ============================================================
 * ContentController — Endpoint public : tout le contenu du site
 * Utilisé par React pour charger dynamiquement les textes de toutes les pages
 * GET /api/v1/contenu
 * ============================================================
 */
class ContentController extends Controller
{
    ...
    {
        // Retourne toutes les clés de contenu avec valeurs courantes
        $contenu = [
